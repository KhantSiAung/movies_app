...
//
//     final moviesData = moviesDataFromJson(jsonString);

import 'dart:convert';

MoviesData moviesDataFromJson(String str) => MoviesData.fromJson(json.decode(str));

String moviesDataToJson(MoviesData data) => json.encode(data.toJson());
...
enum Quality { THE_720_P, THE_1080_P, THE_2160_P }
